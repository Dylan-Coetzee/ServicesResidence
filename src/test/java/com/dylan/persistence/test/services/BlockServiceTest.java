...
import static com.dylan.persistence.test.services.AddressServiceTest.ctx;
...
public class BlockServiceTest {
    ...
    @Test
     public void total() {
         service = ctx.getBean(BlockServices.class);
         List<Block> block = service.getBlock();
         
         Assert.assertEquals(0, block.size(), " Expect no blocks");
