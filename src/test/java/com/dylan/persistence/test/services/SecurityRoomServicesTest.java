 ...
 * @author Dylan
 */
public class SecurityRoomServicesTest {
     public static ApplicationContext ctx;
     private SecurityRoomServices service;
     
    public SecurityRoomServicesTest() {
    }
    ...
    @Test
     public void total() {
         service = ctx.getBean(SecurityRoomServices.class);
         List<SecurityRoom> students = service.getSecurities();
