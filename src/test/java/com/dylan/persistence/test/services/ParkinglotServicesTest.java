...
import com.dylan.persistence.services.ParkingLotServices;
...
public class ParkinglotServicesTest {
    ...
    private ParkingLotServices service;
    
    public ParkinglotServicesTest() {
    }
    ...
    @Test
     public void total() {
         service = ctx.getBean(ParkingLotServices.class);
         List<Parkinglot> cars = service.getSpaces();
         
         Assert.assertEquals(0, cars.size(), " Expert no Cars");
