 ...
 * @author Dylan
 */
public class MediaCentreServicesTest {
    public static ApplicationContext ctx;
    private MediaCentreServices service;
     
    public MediaCentreServicesTest() {
    }
    ...
    @Test
     public void total() {
         service = ctx.getBean(MediaCentreServices.class);
         List<MediaCentre> students = service.getPeople();
